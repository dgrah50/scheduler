      ...
      <div className="overflow-y-scroll  bg-white">
        <ul className="">
          {messages?.map((message) => (
            ...
            >
              <div className="flex items-center border-gray-200  px-4 py-4 sm:px-6">
...
function Header() {
  return (
    <div className="sticky top-0 z-10  border-x border-gray-200 bg-white/75 pb-4 pl-4 pr-6 pt-4 backdrop-blur-md sm:pl-6 lg:pl-8 xl:border-t-0 xl:pl-6 xl:pt-6">
      <div className="sticky flex max-w-7xl items-center lg:top-0">
